...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        transition_copy_check=anti_copy(word,children)

        detect_copy_check=anti_copy(word,list_to_detect)
        ...
        elif transition_copy_check[0]==True:

            try:
                getattr(FSM, transition_copy_check[1])()
                children = get_child_from_state(FSM.state, transitions)
                state_history.append(FSM.state)
