...
def main():
    ...
    parser.add_argument('--keyword_path', help="Absolute path to a Porcupine keyword file.",default='/home/mike/catkin_ws/src/recognition/porcupine/resources/keyword_files/linux/jarvis_linux.ppn')

    parser.add_argument('--context_path', help="Absolute path to a Rhino context file.",default='/home/mike/Picovoice/street_en_linux_2021-05-19-utc_v1_6_0.rhn')
